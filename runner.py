...
def obstacle_movement(obstacle_list):
    if obstacle_list:
        for obstacle_rect in obstacle_list:obstacle_rect.x -= 5
...
game_exit_message = test_font.render('Press Esc to Quit',False,(111,196,169))
game_exit_message_rect = game_exit_message.get_rect(center = (400,375))
...
while True:
    ...
    if game_active:
        ...
        screen.blit(game_exit_message,game_exit_message_rect)
